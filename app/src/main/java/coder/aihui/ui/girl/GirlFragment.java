...
import coder.aihui.app.Constants;
import coder.aihui.base.BaseFragment;
import coder.aihui.data.bean.GirlsBean;
import coder.aihui.util.BitmapUtil;
import coder.aihui.widget.PinchImageView;
...
//        if (isSuccess) {
//            Snackbar.make(mRootView, "大爷，下载好了呢~", Snackbar.LENGTH_LONG).showDialog();
//        } else {
//            Snackbar.make(mRootView, "大爷，下载出错了哦~", Snackbar.LENGTH_LONG).showDialog();
//        }
    }
...
//                startActivity(Intent.createChooser(shareIntent, "分享MeiZhi到"));
//            } else {
//                Snackbar.make(mRootView, "大爷，分享出错了哦~", Snackbar.LENGTH_LONG).showDialog();
//            }
        }
    }
