...
//
//
//public class DownPresenter222 implements RxBusPresenter {
...
//    };
//
//    public DownPresenter222(DownView view, DaoSession mDaossion) {
//        mView = view;
...
//
//        PublishSubject.create(new Observable.OnSubscribe<DownLoadBean>() {
//            @Override
...
//                            }
//                            final DownLoadBean downLoadBean1 = new DownLoadBean();
...
//
//            }
//        }).flatMap(new Func1<DownLoadBean, Observable<Integer>>() {
//            @Override
//            public Observable<Integer> call(final DownLoadBean loadBean) {
//                return mRemoteMyDataSource.saveDatas(loadBean, new MyLoadDatasCallback(loadBean.getType()) {
//                    @Override
...
//                mView.showProgress(integer, bean.getType());
//            }
//        });
//
//
...
//            @Override
//            public synchronized void onDatasLoadedProgress(int index, String enties) {
...
//
//
//          /*      .subscribe(new SerializedObserver(new Observer<DownLoadBean>() {
//            @Override
...
//            }
//            @Override
//            public void onNext(final DownLoadBean mBean) {
//
//            }
//        }));*/
//
