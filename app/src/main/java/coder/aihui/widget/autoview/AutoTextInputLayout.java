...
public class AutoTextInputLayout extends TextInputLayout {
    ...
    public AutoTextInputLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoTextInputLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
