...
public class InspectXJActivity$$ViewBinder<T extends InspectXJActivity> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends InspectXJActivity> implements Unbinder {
    ...
    protected InnerUnbinder(final T target, Finder finder, Object source) {
      ...
      view = finder.findRequiredView(source, 2131755432, "field 'mIvPz' and method 'onViewClicked'");
      target.mIvPz = finder.castView(view, 2131755432, "field 'mIvPz'");
      view2131755432 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
      ...
      view = finder.findRequiredView(source, 2131755307, "field 'mFabXj' and method 'onViewClicked'");
      target.mFabXj = finder.castView(view, 2131755307, "field 'mFabXj'");
      view2131755307 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
      ...
      view = finder.findRequiredView(source, 2131755308, "field 'mFabNum' and method 'onViewClicked'");
      target.mFabNum = finder.castView(view, 2131755308, "field 'mFabNum'");
      view2131755308 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
