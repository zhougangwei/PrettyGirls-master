...
public class AzysDetailActivity$$ViewBinder<T extends AzysDetailActivity> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends AzysDetailActivity> implements Unbinder {
    ...
    protected InnerUnbinder(final T target, Finder finder, Object source) {
      ...
      target.mIvPic = finder.findRequiredViewAsType(source, 2131755446, "field 'mIvPic'", ImageView.class);
      target.mTvWord = finder.findRequiredViewAsType(source, 2131755447, "field 'mTvWord'", TextView.class);
      ...
      view = finder.findRequiredView(source, 2131755286, "field 'mIvQianming' and method 'onViewClicked'");
      target.mIvQianming = finder.castView(view, 2131755286, "field 'mIvQianming'");
      view2131755286 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
