...
public class AssetQueryConfigActivity$$ViewBinder<T extends AssetQueryConfigActivity> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends AssetQueryConfigActivity> implements Unbinder {
    ...
    protected InnerUnbinder(final T target, Finder finder, Object source) {
      ...
      target.mTvWay = finder.findRequiredViewAsType(source, 2131755214, "field 'mTvWay'", TextView.class);
      view = finder.findRequiredView(source, 2131755213, "field 'mLlWay' and method 'onViewClicked'");
      target.mLlWay = finder.castView(view, 2131755213, "field 'mLlWay'");
      view2131755213 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
